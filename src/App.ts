...
export class App {
  ...
  public async init(): Promise<void> {
    ...
    // Vanilla self-hosted build: no upsell banner (see ProBanner.ts, left
    // otherwise untouched -- its exports are simply never called now).
    this.updateConnectivityUi();
