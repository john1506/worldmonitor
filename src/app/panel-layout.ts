        ...
        <div class="map-section${mapStartsCollapsed ? ' collapsed' : ''}" id="mapSection">
          <div class="panel-header">
            ...
            <div class="map-header-actions">
              ...
              <button class="map-pin-btn" id="flatEarthViewBtn" title="Flat Earth View (just for fun)">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/></svg>
              </button>
